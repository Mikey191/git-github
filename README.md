...
**Перед добавлением файлов в индекс полезно проверить их статус. Для этого используется команда**:`git status`. Эта команда выводит информацию о текущем состоянии репозитория, включая:
...
Е**сли вам нужно добавить только один конкретный файл в индекс**, вы можете использовать команду: `git add имя_файла`. Например, если вы хотите добавить файл `index.html`, выполните: `git add index.html`.
...
### 4.5 **Создание репозитория на `GitHub`**
...
2. **Перейти во вкладку Репозитории**
   ...
   - <img src="img/github-face-page-repo-red.jpg.png" width="500px">
3. **Нажать на кнопку Новый репозиторий**
   ...
   - <img src="img/github-repo-page-new-repo-button.jpg.png" width="500px">
4. **Придумать имя для вашего проекта**
   ...
   - <img src="img/github-new-repo-page-name.png" width="500px">
5. **Выбрать статус вашего репозитория**
   ...
   - <img src="img/github-new-repo-page-public-private.png" width="500px">
6. **Создание репозитория**
   ...
   - <img src="img/github-new-repo-page-create-button.png" width="500px">
...
<img src="img/github-new-repo-page-finish.jpg" width="500px">
